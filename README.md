...
下面这组截图按页面分组整理，便于快速对照 AgentScope 的主要功能入口与视觉状态。截图文件统一存放在 `docs/screenshots/`。

### 数据总览
|  |  |
| --- | --- |
| <img src="docs/screenshots/01-data-overview.png" alt="数据总览" /> | <img src="docs/screenshots/09-data-overview-2.png" alt="数据总览补充视图" /> |

### 数据任务
|  |  |
| --- | --- |
| <img src="docs/screenshots/02-data-tasks.png" alt="数据任务" /> | <img src="docs/screenshots/10-data-tasks-2.png" alt="数据任务补充视图" /> |
...
|  |  |
| --- | --- |
| <img src="docs/screenshots/03-system-admin.png" alt="系统管理" /> | <img src="docs/screenshots/04-system-admin-health.png" alt="系统管理健康巡检" /> |
