...
AgentScope 的核心界面与入口如下。

### 数据总览
<img src="docs/screenshots/11-data-overview-3.png" alt="数据总览1" />

<img src="docs/screenshots/01-data-overview.png" alt="数据总览2" />

### 数据资产
<img src="docs/screenshots/08-data-assets.png" alt="数据资产" />

### 数据任务
<img src="docs/screenshots/09-data-overview-2.png" alt="数据任务1" />

<img src="docs/screenshots/02-data-tasks.png" alt="数据任务2" />

### 数据统计分析
<img src="docs/screenshots/10-data-tasks-2.png" alt="数据统计分析1" />

<img src="docs/screenshots/05-data-statistics.png" alt="数据统计分析2" />
